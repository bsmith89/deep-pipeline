#!/usr/bin/env python3
"""Retrieve the significant hits from a sequence file.

Takes a hmmsearch tabular output file, identifies and retries ORFs,
in nucleotide space, which have E-values over the given threshold."""
